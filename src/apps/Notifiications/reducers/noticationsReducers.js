...
export default function notificationReducer(state = {}, action) {
  switch (action.type) {
    ...
    case types.FETCH_NOTIFICATIONS_SUCCESSFUL:
      return Object.assign({}, state, {success_message: action.message, last_call: "passed", isFetching: action.isFetching});
    case types.FETCH_NOTIFICATIONS_FAILED:
      return Object.assign({}, state, {error_message: action.error, last_call: "failed", isFetching: action.isFetching});
    default:
      return state;
  }
}
