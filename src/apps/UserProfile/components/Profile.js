              ...
              <div className="row">
                ...
                <div className="col-md-9">
                  ...
                  <div>
                      ...
                      <li style={{ listStyleType: "none" }}>{profile.bio}</li>
                      <li style={{ listStyleType: "none" }}>{profile.country}</li>  
                      <li style={{ listStyleType: "none" }}><em>{profile.twitter_handle}</em></li>
                      <li style={{ listStyleType: "none" }}>{profile.phone_number}</li>
                      <li style={{ listStyleType: "none" }}><a href={profile.website}>{profile.website}</a></li>
